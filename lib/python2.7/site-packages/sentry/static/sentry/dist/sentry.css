...
.dropdown-submenu:focus > a {
  ...
  background-image: -moz-linear-gradient(top, #2e9fff, #1593ff);
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#2e9fff), to(#1593ff));
  background-image: -webkit-linear-gradient(top, #2e9fff, #1593ff);
  background-image: -o-linear-gradient(top, #2e9fff, #1593ff);
  background-image: linear-gradient(to bottom, #2e9fff, #1593ff);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff2e9fff', endColorstr='#ff1593ff', GradientType=0);
}
...
.btn-primary {
  ...
  background-image: -moz-linear-gradient(top, #2e9fff, #2e59ff);
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#2e9fff), to(#2e59ff));
  background-image: -webkit-linear-gradient(top, #2e9fff, #2e59ff);
  background-image: -o-linear-gradient(top, #2e9fff, #2e59ff);
  background-image: linear-gradient(to bottom, #2e9fff, #2e59ff);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff2e9fff', endColorstr='#ff2e59ff', GradientType=0);
  border-color: #2e59ff #2e59ff #002fe1;
  border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);
...
.nav .dropdown-toggle:focus .caret {
  border-top-color: #0087fa;
  border-bottom-color: #0087fa;
}
...
@font-face {
  ...
  src: url('../fonts/sentry-simple.eot?#iefix-iwi56z') format('embedded-opentype'), url('../fonts/sentry-simple.woff?-iwi56z') format('woff'), url('../fonts/sentry-simple.ttf?-iwi56z') format('truetype'), url('../fonts/sentry-simple.svg?-iwi56z#sentry-simple') format('svg');
  font-weight: normal;
  font-style: normal;
}
...
.select2-container .select2-choice {
  ...
  -moz-border-radius: 3px;
  border-radius: 3px;
  -webkit-box-shadow: 0 1px 1px rgba(205, 216, 227, 0.32);
  -moz-box-shadow: 0 1px 1px rgba(205, 216, 227, 0.32);
  box-shadow: 0 1px 1px rgba(205, 216, 227, 0.32);
  -webkit-background-clip: padding-box;
  -moz-background-clip: padding-box;
  background-clip: padding-box;
  -moz-background-clip: padding;
...
.select2-container .select2-choice abbr {
  ...
  height: 12px;
  font-size: 1px;
  background: url('../scripts/lib/select2/select2.png') right top no-repeat;
  cursor: pointer;
  text-decoration: none;
  border: 0;
  outline: 0;
...
.select2-container .select2-choice div b {
  background: url('../scripts/lib/select2/select2.png') no-repeat 0 1px;
  display: block;
  width: 100%;
  height: 100%;
}
...
.select2-search input {
  background: #ffffff url('../scripts/lib/select2/select2.png') no-repeat 99% -22px;
  background: url('../scripts/lib/select2/select2.png') no-repeat 99% -22px, -webkit-gradient(linear, left bottom, left top, color-stop(0.85, #ffffff), color-stop(0.99, #eeeeee));
  background: url('../scripts/lib/select2/select2.png') no-repeat 99% -22px, -webkit-linear-gradient(center bottom, #ffffff 85%, #eeeeee 99%);
  background: url('../scripts/lib/select2/select2.png') no-repeat 99% -22px, -moz-linear-gradient(center bottom, #ffffff 85%, #eeeeee 99%);
  background: url('../scripts/lib/select2/select2.png') no-repeat 99% -22px, -o-linear-gradient(bottom, #ffffff 85%, #eeeeee 99%);
  background: url('../scripts/lib/select2/select2.png') no-repeat 99% -22px, -ms-linear-gradient(top, #ffffff 85%, #eeeeee 99%);
  background: url('../scripts/lib/select2/select2.png') no-repeat 99% -22px, linear-gradient(top, #ffffff 85%, #eeeeee 99%);
...
.select2-search input.select2-active {
  background: #ffffff url('../scripts/lib/select2/spinner.gif') no-repeat 100%;
  background: url('../scripts/lib/select2/spinner.gif') no-repeat 100%, -webkit-gradient(linear, left bottom, left top, color-stop(0.85, #ffffff), color-stop(0.99, #eeeeee));
  background: url('../scripts/lib/select2/spinner.gif') no-repeat 100%, -webkit-linear-gradient(center bottom, #ffffff 85%, #eeeeee 99%);
  background: url('../scripts/lib/select2/spinner.gif') no-repeat 100%, -moz-linear-gradient(center bottom, #ffffff 85%, #eeeeee 99%);
  background: url('../scripts/lib/select2/spinner.gif') no-repeat 100%, -o-linear-gradient(bottom, #ffffff 85%, #eeeeee 99%);
  background: url('../scripts/lib/select2/spinner.gif') no-repeat 100%, -ms-linear-gradient(top, #ffffff 85%, #eeeeee 99%);
  background: url('../scripts/lib/select2/spinner.gif') no-repeat 100%, linear-gradient(top, #ffffff 85%, #eeeeee 99%);
}
...
.select2-dropdown-open .select2-choice {
  -webkit-box-shadow: 0 0 0 2px #a7aeb7;
  -moz-box-shadow: 0 0 0 2px #a7aeb7;
  box-shadow: 0 0 0 2px #a7aeb7;
  -webkit-border-bottom-left-radius: 0;
  -webkit-border-bottom-right-radius: 0;
  -moz-border-radius-bottomleft: 0;
  -moz-border-radius-bottomright: 0;
...
.select2-container-multi .select2-choices .select2-search-field input.select2-active {
  background: #ffffff url('../scripts/lib/select2/spinner.gif') no-repeat 100% !important;
}
.select2-default {
...
@media only screen and (-webkit-min-device-pixel-ratio: 1.5) {
  ...
  .select2-search-choice-close,
  .select2-container .select2-choice abbr {
    background-image: url(../scripts/lib/select2/select2x2.png) !important;
...
.navbar #team-banner > a small {
  font-weight: normal;
  margin-left: 5px;
  color: #cdd8e3;
  font-size: 100%;
}
.navbar #team-banner .divider {
  padding: 0 2px;
  opacity: .75;
}
.navbar #team-banner.open > a.dropdown-toggle {
  background: #313944;
}
.navbar #team-banner .dropdown-menu {
  max-height: 400px;
  min-width: 500px;
  overflow: auto;
  top: 56px;
...
.navbar #team-banner .dropdown-menu select {
  border: 0;
  width: 100%;
}
.navbar #team-banner .dropdown-menu h6 {
  color: #889ab0;
...
.navbar #team-banner .dropdown-menu h6 a {
  color: inherit;
  -webkit-transition: none;
  -moz-transition: none;
  -o-transition: none;
...
.navbar #team-banner .dropdown-menu .project-list {
  margin: 0;
}
.navbar #team-banner .dropdown-menu .project-list li {
  margin: 0;
  display: inline-block;
  font-size: 15px;
}
.navbar #team-banner .dropdown-menu .project-list li a {
  color: #d2d8e1;
  width: 160px;
  overflow: hidden;
  text-overflow: ellipsis;
...
.navbar #team-banner .dropdown-menu .project-list li a:hover {
  color: #fff !important;
  background: transparent;
}
.navbar #team-banner .dropdown-menu .project-list li.active a {
  color: #fff;
  background: inherit;
}
.navbar #team-banner .dropdown-menu input[type=text] {
  width: 380px;
  padding-right: 40px;
}
.navbar #team-banner .dropdown-menu .btn {
  margin: 0;
  -webkit-border-radius: 0 4px 4px 0;
  -moz-border-radius: 0 4px 4px 0;
  border-radius: 0 4px 4px 0;
...
.navbar #team-nav ul:before,
.navbar #team-nav ul:after {
  display: table;
  content: "";
  line-height: 0;
}
...
.navbar #team-nav ul li {
  list-style-type: none;
  float: left;
}
.navbar #team-nav ul li a {
  text-decoration: none;
  display: block;
  font-size: 16px;
  font-weight: bold;
...
.navbar #team-nav ul li a:hover {
  color: #bcc1c8;
}
.navbar #team-nav ul li.active a {
  color: #737d8c;
  height: 61px;
  background: #dee3e9;
  -webkit-box-shadow: none;
...
.navbar .nav > li.active:focus > a {
  ...
  -webkit-box-shadow: inset 0 1px 0px rgba(255, 255, 255, 0.15), 0 1px 2px rgba(0, 0, 0, 0.1);
  -moz-box-shadow: inset 0 1px 0px rgba(255, 255, 255, 0.15), 0 1px 2px rgba(0, 0, 0, 0.1);
  box-shadow: inset 0 1px 0px rgba(255, 255, 255, 0.15), 0 1px 2px rgba(0, 0, 0, 0.1);
}
.org-dropdown .dropdown-menu .new {
  display: inline;
  padding: 0;
}
.org-dropdown .dropdown-menu .new .icon-plus {
  background: none;
}
.org-dropdown .dropdown-menu h6 {
  margin: 0 8px 4px 12px;
}
.org-dropdown .dropdown-menu .divider {
  margin: 4px 0;
}
.org-dropdown .dropdown-menu li {
  position: relative;
}
.org-dropdown .dropdown-menu li a {
  padding-right: 34px;
  padding-left: 12px;
}
.org-dropdown .dropdown-menu li .org-settings {
  position: absolute;
  right: 9px;
  top: 4px;
  padding: 0;
}
.org-dropdown .dropdown-menu li .org-settings span {
  background: none;
}
...
.toolbar .navbar-search .search-query {
  height: 18px;
  color: #6b767e;
  width: 194px;
  -webkit-border-radius: 5px;
  ...
  font-size: 13px;
  background: #fff;
  -webkit-box-shadow: 0 2px 0 rgba(185, 200, 215, 0.26);
  -moz-box-shadow: 0 2px 0 rgba(185, 200, 215, 0.26);
  box-shadow: 0 2px 0 rgba(185, 200, 215, 0.26);
}
.toolbar .navbar-search .search-query:focus {
  text-shadow: none;
}
.toolbar .navbar-search .search-query:-moz-placeholder {
  color: #bec6cc;
}
.toolbar .navbar-search .search-query:-ms-input-placeholder {
  color: #bec6cc;
}
.toolbar .navbar-search .search-query::-webkit-input-placeholder {
  color: #bec6cc;
}
...
#content.with-sidebar {
  background: #ffffff url(../images/dashboard/sidebar-bg.png) top right repeat-y;
  min-width: 1086px;
}
...
#content.with-sidebar section.body {
  min-width: 0;
}
...
#content.with-left-sidebar .sidebar .nav a {
  padding: 5px 15px;
  margin: 0;
  -webkit-border-radius: 4px;
  -moz-border-radius: 4px;
...
#content.with-left-sidebar .sidebar .nav a:hover {
  background: #F0F2F5;
  color: #747B88;
}
#content.with-left-sidebar .sidebar .nav .active a:hover,
#content.with-left-sidebar .sidebar .nav .active a {
  background: #2e9fff;
  color: #fff;
}
#content.with-left-sidebar section.body {
  min-width: 0;
}
#content .content {
  *zoom: 1;
...
#content .btn-toolbar:last-child {
  border: 0;
}
#content section.body .btn-toolbar {
  padding: 15px 0;
}
#content section.body .event-toolbar {
  padding: 0;
  margin: 0 0 20px;
  border-bottom: 0;
  text-align: center;
}
#content section.body .event-toolbar .next span,
#content section.body .event-toolbar .prev span {
  display: inline-block;
  top: 5px;
}
#content section.body .event-toolbar h4 {
  line-height: 20px;
  font-weight: normal;
  color: #aaa;
}
...
#content .sidebar .nav.nav-tabs.nav-stacked.counted-list,
#content .sidebar .nav.counted-list.counted-list {
  margin: 0 -45px 17px;
}
...
#content .sidebar .nav.nav-tabs.nav-stacked.counted-list li .progressbar,
#content .sidebar .nav.counted-list.counted-list li .progressbar {
  padding: 5px 0;
}
...
#content .sidebar .nav.nav-tabs.nav-stacked li:last-child {
  margin-bottom: 0;
}
...
#content .sidebar .nav.nav-tabs.nav-stacked li.active a {
  position: relative;
  color: #2e9fff;
  -webkit-box-shadow: none;
  -moz-box-shadow: none;
...
ul.tag-list li .progressbar {
  padding: 5px 0;
}
ul.tag-list li:nth-child(even) {
  background: #f9f9f9;
}
ul.tag-list li span {
  position: absolute;
...
.frame > div > table.vars {
  margin-bottom: 5px;
}
.frame > div > table.vars > tbody > tr > th {
  color: #465262;
  text-align: right;
}
.frame.expanded {
...
.expanded table.vars.expandable {
  display: table;
}
ol.context {
  cursor: pointer;
...
ol.context > li:first-child {
  -webkit-border-radius: 4px 4px 0 0;
  -moz-border-radius: 4px 4px 0 0;
  border-radius: 4px 4px 0 0;
}
ol.context > li:last-child {
  -webkit-border-radius: 4px 4px 0 0;
  -moz-border-radius: 4px 4px 0 0;
  border-radius: 4px 4px 0 0;
}
ol.context li.closed {
  -webkit-border-radius: 4px;
  -moz-border-radius: 4px;
  border-radius: 4px;
}
...
ol.context:hover li.active {
  background-color: #e0e0e0;
}
ol.context-line > li > span {
  float: right;
}
.frame-errors ol.context .error {
  margin: 0;
  padding: 0;
  background: #ff2e46;
  color: #fff;
...
.frame-errors ol.context > li {
  background: #fff0f2;
}
.frame-errors ol.context > li.active {
  background: #ffc7cd;
}
.module {
  margin-bottom: 20px;
...
.datepicker-box {
  ...
  -moz-box-shadow: 0 0 0 2px rgba(70, 82, 98, 0.43);
...
.datepicker-box .radio-inputs .radio input {
  margin-left: -19px;
  margin-top: 7px;
  vertical-align: middle;
}
...
#event_nav.fixed .event_nav_wrap > ul {
  overflow: hidden;
  -webkit-box-sizing: border-box;
  -moz-box-sizing: border-box;
  box-sizing: border-box;
...
#event_nav.fixed .event_nav_wrap > ul li.dropdown {
  position: relative;
}
#event_nav.fixed .event_nav_wrap > ul li.top {
  float: right;
  display: block;
}
#event_nav {
...
#event_nav .event_nav_wrap > ul {
  padding: 10px 12px;
  margin: 0 -30px 0;
  border-top: 1px solid #dee3e9;
  -webkit-box-shadow: 0 1px 0 rgba(0, 0, 0, 0.08), 0 1px 3px rgba(0, 0, 0, 0.05);
  -moz-box-shadow: 0 1px 0 rgba(0, 0, 0, 0.08), 0 1px 3px rgba(0, 0, 0, 0.05);
  box-shadow: 0 1px 0 rgba(0, 0, 0, 0.08), 0 1px 3px rgba(0, 0, 0, 0.05);
}
#event_nav .event_nav_wrap > ul > li {
  margin: 0 4px 0 0;
}
#event_nav .event_nav_wrap > ul > li.top {
  display: none;
}
#event_nav .event_nav_wrap > ul > li > a {
  padding: 8px 18px;
  line-height: 16px;
  color: #89919b;
  margin: 0;
...
#event_nav .event_nav_wrap > ul > li > a:hover,
#event_nav .event_nav_wrap > ul > li > a:focus {
  -webkit-transition: none;
  -moz-transition: none;
  -o-transition: none;
  transition: none;
...
#event_nav .event_nav_wrap > ul > li.active > a {
  -webkit-transition: none;
  -moz-transition: none;
  -o-transition: none;
  transition: none;
...
#event_nav .event_nav_wrap > ul > li > ul.dropdown-menu > li.active > a,
#event_nav .event_nav_wrap > ul > li > ul.dropdown-menu > li:hover > a,
#event_nav .event_nav_wrap > ul > li > ul.dropdown-menu > li:focus > a {
  color: #ffffff;
}
...
.welcome-message p.links {
  font-size: 16px;
}
.welcome-message p.links a {
  margin: 0 12px 0 0;
}
.welcome-message pre {
  display: block;
...
section.body input[type="datetime"],
section.body input[type="datetime-local"],
section.body input[type="date"],
section.body input[type="month"],
section.body input[type="time"],
section.body input[type="week"],
section.body input[type="number"],
section.body input[type="email"],
section.body input[type="url"],
section.body input[type="search"],
section.body input[type="tel"],
section.body input[type="color"],
section.body .uneditable-input {
  height: auto;
  line-height: auto;
  border: 1px solid #c3c8ce;
  padding: 6px 12px;
...
section.body textarea:-moz-placeholder,
section.body input[type="text"]:-moz-placeholder,
section.body input[type="password"]:-moz-placeholder,
section.body input[type="datetime"]:-moz-placeholder,
section.body input[type="datetime-local"]:-moz-placeholder,
section.body input[type="date"]:-moz-placeholder,
section.body input[type="month"]:-moz-placeholder,
section.body input[type="time"]:-moz-placeholder,
section.body input[type="week"]:-moz-placeholder,
section.body input[type="number"]:-moz-placeholder,
section.body input[type="email"]:-moz-placeholder,
section.body input[type="url"]:-moz-placeholder,
section.body input[type="search"]:-moz-placeholder,
section.body input[type="tel"]:-moz-placeholder,
section.body input[type="color"]:-moz-placeholder,
section.body .uneditable-input:-moz-placeholder {
  color: #d6d9db;
}
section.body textarea:-ms-input-placeholder,
section.body input[type="text"]:-ms-input-placeholder,
section.body input[type="password"]:-ms-input-placeholder,
section.body input[type="datetime"]:-ms-input-placeholder,
section.body input[type="datetime-local"]:-ms-input-placeholder,
section.body input[type="date"]:-ms-input-placeholder,
section.body input[type="month"]:-ms-input-placeholder,
section.body input[type="time"]:-ms-input-placeholder,
section.body input[type="week"]:-ms-input-placeholder,
section.body input[type="number"]:-ms-input-placeholder,
section.body input[type="email"]:-ms-input-placeholder,
section.body input[type="url"]:-ms-input-placeholder,
section.body input[type="search"]:-ms-input-placeholder,
section.body input[type="tel"]:-ms-input-placeholder,
section.body input[type="color"]:-ms-input-placeholder,
section.body .uneditable-input:-ms-input-placeholder {
  color: #d6d9db;
}
section.body textarea::-webkit-input-placeholder,
section.body input[type="text"]::-webkit-input-placeholder,
section.body input[type="password"]::-webkit-input-placeholder,
section.body input[type="datetime"]::-webkit-input-placeholder,
section.body input[type="datetime-local"]::-webkit-input-placeholder,
section.body input[type="date"]::-webkit-input-placeholder,
section.body input[type="month"]::-webkit-input-placeholder,
section.body input[type="time"]::-webkit-input-placeholder,
section.body input[type="week"]::-webkit-input-placeholder,
section.body input[type="number"]::-webkit-input-placeholder,
section.body input[type="email"]::-webkit-input-placeholder,
section.body input[type="url"]::-webkit-input-placeholder,
section.body input[type="search"]::-webkit-input-placeholder,
section.body input[type="tel"]::-webkit-input-placeholder,
section.body input[type="color"]::-webkit-input-placeholder,
section.body .uneditable-input::-webkit-input-placeholder {
  color: #d6d9db;
}
...
table.vars tbody > tr:nth-child(odd) > td,
table.vars tbody > tr:nth-child(odd) > th {
  background-color: #F4F6F9;
}
table.vars tbody > tr:nth-child(even) > td,
table.vars tbody > tr:nth-child(even) > th {
  background-color: #fff;
}
table.vars table.vars td,
table.vars table.vars th {
  padding: 5px 10px;
}
.table-striped tbody tr:nth-child(odd) td,
.table-striped tbody tr:nth-child(odd) th {
...
table.simple-list .user-info {
  padding-left: 65px;
  position: relative;
}
table.simple-list .user-info .avatar {
  width: 40px;
  height: 40px;
  position: absolute;
  left: 15px;
...
table.member-list .status strong {
  display: block;
  font-size: 14px;
  margin-bottom: 2px;
  margin-top: -3px;
}
table.member-list .status .btn {
  padding: 1px 8px;
}
.table tbody tr.success > td {
  background-color: #dff0d8;
...
.team-list > li h3 .actions {
  font-size: 14px;
}
.team-list > li h3 .actions a {
  color: #949BA5;
}
.team-list > li h3 .actions a:hover {
  color: #6c7480;
}
.team-list > li h3 .actions .icon-cog {
  background: none;
  margin-top: 2px;
  margin-right: 5px;
}
...
.windowed #content.with-left-sidebar {
  width: 900px;
  min-width: 900px;
  background: #ffffff url(../images/dashboard/sidebar-bg.png) -50px top repeat-y;
}
.windowed #content.with-left-sidebar .content {
  padding-left: 250px;
}
.windowed #content.with-left-sidebar .main {
  min-width: 0;
  float: right;
}
.windowed #content.with-left-sidebar .sidebar {
  width: 190px;
  display: block;
  margin-right: 0;
  margin-top: 0;
...
.windowed #content.with-left-sidebar section.body {
  min-width: 0;
}
.windowed-small {
  background: #c8cbd0;
}
.windowed-small .outer-wrapper {
  width: auto;
  max-width: 400px;
}
.windowed-small footer,
.windowed-small header {
  text-align: center;
  padding: 0;
  min-width: 0;
  width: auto;
...
.create-flow .help-block {
  font-size: 14px;
  color: #465262;
  line-height: 1.4;
  margin-bottom: 20px;
}
.create-flow .control-group {
  margin-bottom: 20px;
}
.create-flow input[type="text"] {
  box-sizing: border-box;
  -moz-box-sizing: border-box;
  width: 100%;
  margin: 0;
...
.create-flow .steps:before,
.create-flow .steps:after {
  display: table;
  content: "";
  line-height: 0;
}
...
.create-flow .steps li.active {
  color: #465262;
}
.create-flow .steps li:first-child {
  text-align: left;
}
.create-flow .steps li:last-child {
  text-align: right;
}
.docs #content {
...
.docs .select-project .caret {
  border-top-color: #fff !important;
  border-bottom-color: #fff !important;
}
.docs .select-project .dropdown-toggle {
  color: #fff;
}
.docs .select-project.open .dropdown-toggle {
  text-decoration: none;
  position: relative;
  z-index: 2;
}
.docs .select-project.open .dropdown-toggle:after {
  display: block;
  content: "";
  position: absolute;
  top: -4px;
...
.docs .docs-sidebar h4 {
  font-size: 14px;
  margin: 0 0 15px;
}
.docs .docs-sidebar ul {
  margin: 0 0 15px;
  list-style-type: none;
}
.docs .docs-sidebar ul li a {
  line-height: 22px;
  margin-left: -30px;
  margin-right: -30px;
  padding: 0 30px;
...
.client-platform-list:before,
.client-platform-list:after {
  display: table;
  content: "";
  line-height: 0;
}
...
.client-platform-list li:nth-child(5n) {
  margin-right: 0 !important;
}
.client-platform-list .big-platformicon {
  font-size: 54px;
}
.client-platform-list span {
  width: 100px;
  height: 100px;
  margin: 0 auto 20px;
  display: block;
...
.client-platform-list span.platformicon-generic {
  background: #929c9e;
}
.client-platform-list span.platformicon-python {
  background: #2671aa;
}
.client-platform-list span.platformicon-php {
  background: #6067a8;
}
.client-platform-list span.platformicon-ruby,
.client-platform-list span.platformicon-rails {
  background: #d71f26;
}
.client-platform-list span.platformicon-rails-3 {
  background: #e4454b;
}
.client-platform-list span.platformicon-java {
  background: #ca1d24;
}
.client-platform-list span.platformicon-js {
  color: #1b191c;
  background: #f7dc3c;
}
.client-platform-list span.platformicon-node-js {
  background: #8ac655;
  color: #2d292f;
}
.client-platform-list span.platformicon-go {
  color: #222;
  border: 2px solid #222;
}
.client-platform-list span.platformicon-django {
  background: #025129;
}
.client-platform-list span.platformicon-ios {
  background: #383a3a;
}
.client-platform-list a {
  font-size: 16px;
  text-align: center;
  display: block;
  font-weight: 500;
...
.provider-logo.google {
  background: url(../images/auth-providers/google.png);
  background-size: cover;
}
.provider-logo.github {
  background: url(../images/auth-providers/github.jpg);
  background-size: cover;
}
.provider-logo.onelogin {
  background: url(../images/auth-providers/onelogin.png);
  background-size: cover;
}
.provider-logo.okta {
...
.org-login .org-avatar {
  width: 54px;
  height: 54px;
  border-radius: 54px;
}
.org-login .btn-default {
  border: 1px solid #d1d1d1;
  box-shadow: 0 1px 1px rgba(0, 0, 0, 0.1);
}
.org-login .provider-logo {
  display: inline-block;
  width: 16px;
  height: 16px;
  vertical-align: text-top;
